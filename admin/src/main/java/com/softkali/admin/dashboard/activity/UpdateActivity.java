...
import static com.softkali.admin.util.Constant.update_product;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            category.setAdapter(new ArrayAdapter<String>(UpdateActivity.this, android.R.layout.simple_spinner_item,stringArrayList));
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
